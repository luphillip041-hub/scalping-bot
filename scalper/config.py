...
class Config:
    ...
    volume_spike_mult: float = float(os.getenv("VOLUME_SPIKE_MULT", "2.5"))  # increased from 2.0
    ...
    max_hold_minutes: int = int(os.getenv("MAX_HOLD_MINUTES", "10"))  # reduced from 15

    # Risk
    position_size_usd: float = float(os.getenv("POSITION_SIZE_USD", "2000"))
    max_positions: int = int(os.getenv("MAX_POSITIONS", "8"))  # increased from 5
    ...
    poll_seconds: int = int(os.getenv("POLL_SECONDS", "15"))  # increased from 20
